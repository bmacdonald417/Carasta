      ...
      <section className="border-t border-white/10 py-16 md:py-24">
        <div className="carasta-container">
          <div className="flex items-end justify-between gap-4">
            <div>
              <h2 className="font-display text-3xl font-semibold uppercase tracking-[0.1em] text-neutral-100 md:text-4xl">
                Live Auctions
              </h2>
              <p className="mt-2 text-neutral-400">
                Bid on exceptional collector cars. Reserve meter, auto-bid, buy
                now.
              </p>
            </div>
            <Link
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {recentAuctions.length === 0 ? (
              <div className="col-span-full rounded-2xl border border-white/10 bg-white/5 py-16 text-center">
